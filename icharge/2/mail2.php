...
if(isset($_POST['submit'])){
    ...
    $req=$_POST['message'];
		...
		$subject = 'Darshan International Enquiry';
		$headers = "From:" . $email . "\r\n";
		...
		$message .= '<title>Enquiry For : Darshan International</title></head><body style="font-family:Arial, Helvetica, sans-serif;"><br /><br />';
		


		$message .= '<table  cellspacing="0" cellpadding="10" style="color:#207fdc;border:1px solid #207fdc;" width="600" align="center" >
				<tr bgcolor="#fff"   ><td height="40px" colspan="3" align="center" bgcolor="#207fdc" style="color:#FFF; font-size:16px; font-weight:bold;">Enquiry For <a href="#" style="color:#FFF; text-decoration:none;">Darshan International </a></td></tr>
...
<td style="color:#9a9a9a;">' . $req . '</td></tr></table>';
		...
		print ('<script language="javascript">');
		print ('window.location="contact.php"');
        	print ('</script>'); 
